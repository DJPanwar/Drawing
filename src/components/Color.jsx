...
function Color({ setCurrentColor, setEraserSize, onClean, onSave}) {
  const handleClean = () => {
    onClean();
  };
  const handleSave = () => {
  ...
  return (
    ...
    <div className='border bg-white w-fit p-2 rounded-xl shadow-sm shadow-black'>
      ...
      <div className='m-2 mt-4'>
        ...
        <div className='flex m-2'> <img src={Circle} className='w-8 h-8'></img><button className='mx-3'>Circle</button></div>
        <div className='flex m-2'> <img src={Rectangle} className='w-8 h-8'></img><button className='mx-3'>Rectangle</button></div>
        <div className='flex m-2'> <img src={Triangle} className='w-8 h-8'></img><button className='mx-3'>Triangle</button></div>
      </div>
